...
def run_test(test_name: str, program: Path, input_file: Path, output_file: Path, show_all: bool, show_diff: bool, regenerate: bool):
...
def run_tests(main_test_dir: Path, program: Path, test_dir: Path, show_all: bool, show_diff: bool, regenerate: bool) -> bool:
    ...
    for output_file in output_files:
        if run_test(test_dir.name, program, input_file, output_file, show_all, show_diff, regenerate):
            success_count += 1
...
def main() -> None:
    ...
    program, show_all, show_diff, regenerate = parse_args()
    ...
    for test_dir in test_dirs:
        this_success_count, this_test_count = run_tests(main_test_dir, program, test_dir, show_all, show_diff, regenerate)
