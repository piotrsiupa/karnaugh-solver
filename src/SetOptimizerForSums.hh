...
{
public:
	static Result optimizeSet(const sets_t &sets, Progress &progress) { const auto subtaskGuard = progress.enterSubtask("Sums"); return SetOptimizerForSums().extractCommonParts(sets, progress); }
